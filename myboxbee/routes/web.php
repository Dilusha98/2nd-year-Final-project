...
Route::get('/collections/gift-box-builder-gifts/{url}',GiftboxComponent::class) -> name('gift-box-build');
...
Route::group(['middleware' => ['auth','isuser']],function(){
    ...
    // Route::get('/collection/gift-box-build/{url}', GiftboxComponent::class)-> name('collection.gift-box-build');
...
// Route::post('/get-bar',[CartController::class, 'addtocart']);
