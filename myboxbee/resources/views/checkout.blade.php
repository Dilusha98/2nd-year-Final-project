...
<head>
    ...
    <meta name="csrf-token" content="{{ csrf_token() }}"><!-- <link rel="stylesheet" type="text/css" href="{{asset('assets/css/bootstrap.min.css')}}"> -->
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" style="text-align: center;">
                    <h4>Select Your Payament Type</h4>
                    <br>
                    <div class="row">
                        <div class="col-md-6" style="cursor: pointer;" onclick="ptype(1)">
                        ...
                        <div class="col-md-6 m-auto" style="cursor: pointer;" onclick="ptype(0)">
                            <h6>Online Pyament</h6>
                            <div>
                                <img src="{{asset('img/online.png')}}" alt="" width="100%">
                            </div>
                        ...
                        <div class="card-body">
                            <form action="#" method="post">
                                ...
                                <div class="row" style="display:flex">
                                    ...
                                    <div class="col-md-6"   style="justify-content:center;display:flex;background-color: #eff0f1;padding: 8px;">                                  
                                    <label onclick="ptype(1)">
                                    <h6>Cash On Delivery</h6>
                                    <input type="radio" name="test" value="" checked>
                                    <img src="{{asset('img/cash.png')}}" alt="" width="100%"  style="height:100px">
                                    </label>                      
                                    </div>
                                    <div class="col-md-6" style="justify-content:center;display:flex;background-color: #eff0f1;padding: 8px;">                                    
                                 ...
                                 <br>
                                <span id="method" style="background-color: #090909bf;color: white;font-weight: bold;padding: 4px 14px;border-radius: 25px;"></span>
                                <hr>
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-4">
                                        ...
                                        <div class="col-sm- text-secondary">
                                            <input type="text" class="form-control" id="province" name="address"  required>
                                        </div>
                                    </div>
                                ...
                                <div class="row subtotal" style="font-size: 20px;">
                                    ...
                                    <div class="col-auto ">
                                        ...
                                        <p>
                                            ...
                                            @php $total1 = $total + $s->price @endphp
@endforeach
                                        </p>
                    ...
                    <button class="btn col-md-12" style="background-color: black;color: white;" id="placeorder">PLACE ORDER</button>
                </div>
